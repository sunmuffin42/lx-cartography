    ...
    322: function(e, t, n) {
        (function(t) {
            String.prototype.replaceAll = function(e, t) {
                ...
                function e(e, n, i) {
                    if (t.select("#reloadCachedOntology").classed("hidden", !0), b.reset(), d.options().navigationMenu().hideAllMenus(), void 0 === e && void 0 === n || 0 === e.length) return void O.notValidJsonFile();
                    d.editorMode();
                    var r;
                    if (e) {
                        var a;
                    ...
                    var g = !1;
                    if (location.hash.indexOf("#new_ontology") !== -1 && (g = !0, l++, t.select("#empty").node().href = "#opts=editorMode=true;#new_ontology" + l), 0 === h && d.editorMode() === !1 && g === !1) O.emptyGraphContentError();
                    else {
                        O.validJsonFile(), y.setCachedOntology(n, e), f.setJsonText(e), c.data(r), d.options().loadingModule().setPercentMode(), g === !0 && d.editorMode(!0), d.load(), L.updateOntologyInformation(r, z), f.setFilename(n), d.updateZoomSliderValueFromOutside(), o();
                ...
                function o() {
                    ...
                    "0" === L.getSidebarVisibility() && (o = window.innerHeight - 40, a = window.innerWidth), F.updateLayout(), t.select("#blockGraphInteractions").style("width", window.innerWidth + "px"), t.select("#blockGraphInteractions").style("height", window.innerHeight + "px"), t.select("#WarningErrorMessages").style("width", a + "px"), e.style("height", o + "px"), n.attr("width", a).attr("height", o), c.width(a).height(o), d.updateStyle(), r() === !0 ? (d.isEditorMode() === !0 && (t.select("#modeOfOperationString").node().innerHTML = "touch able device detected"), d.setTouchDevice(!0)) : (d.isEditorMode() === !0 && (t.select("#modeOfOperationString").node().innerHTML = "point & click device detected"), d.setTouchDevice(!1)), t.select("#loadingInfo-container").style("height", .5 * (o - 80) + "px"), O.checkForScreenSize(), i();
                    ...
                    f > 0 ? (g.classed("hidden", !1), h.classed("hidden", !1), k.updateScrollButtonVisibility()) : (g.classed("hidden", !0), h.classed("hidden", !0)), E.updateElementWidth()
                }
                ...
                return s.getOptions = function() {
                    ...
                    window.requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
                        ...
                        clearTimeout(e)
                    }, c.graphContainerSelector(u), c.selectionModules().push(D), c.selectionModules().push(j), c.selectionModules().push(H), c.filterModules().push(B), c.filterModules().push(z), c.filterModules().push(R), c.filterModules().push(A), c.filterModules().push(N), c.filterModules().push(V), c.filterModules().push(P), c.filterModules().push(U), c.filterModules().push(W), c.filterModules().push(T), c.filterModules().push(I), t.select(window).on("resize", o), f.setup(), g.setup(), h.setup(A, N, V, P, U, R), v.setup(H, W, T, I), b.setup(), L.setup(), O.setup(), M.setup(), E.setup(), m.setup();
                    var n = a();
                    if (n > 0 && n <= 11) console.log("Agent version " + n), console.log("This agent is not supported"), t.select("#browserCheck").classed("hidden", !1), t.select("#killWarning").classed("hidden", !0), t.select("#optionsArea").classed("hidden", !0), t.select("#logo").classed("hidden", !0);
                        ...
                        t.select("#logo").classed("hidden", !1), 12 === n ? (t.select("#browserCheck").classed("hidden", !1), t.select("#killWarning").classed("hidden", !1)) : t.select("#browserCheck").classed("hidden", !0), x.setup([g, h, v, D, j, b]), w.setup(), k.setup(), C.setup(), c.literalFilter(B), c.nodeDegreeFilter(R), c.loadingModule(O), c.filterMenu(h), c.modeMenu(v), c.gravityMenu(g), c.pausedMenu(b), c.pickAndPinModule(H), c.resetMenu(x), c.searchMenu(w), c.ontologyMenu(y), c.navigationMenu(k), c.sidebar(L), c.leftSidebar(M), c.editSidebar(E), c.exportMenu(f), c.graphObject(d), c.zoomSlider(C), c.warningModule(S), c.directInputModule(F), c.datatypeFilter(A), c.objectPropertyFilter(N), c.subclassFilter(V), c.setOperatorFilter(U), c.disjointPropertyFilter(P), c.focuserModule(D), c.colorExternalsModule(I), c.compactNotationModule(T), y.setup(e), _.setup(), M.showSidebar(0), M.hideCollapseButton(!0), S.hideEditorHint(), d.start();
                        var i = t.select("#modeOfOperationString");
                        i.style("font-size", "0.6em"), i.style("font-style", "italic"), o();
                        var r, l = d.options().width(),
                            s = d.options().height();
                        r = Math.min(l, s) / 1e3;
                        var p = !0;
                        p === !1 && d.setForceTickFunctionWithFPS(), d.setDefaultZoom(r), t.selectAll(".debugOption").classed("hidden", p);
                        var G = t.select("body");
                        if (t.select(document).on("keydown", function(e) {
                                8 === t.event.keyCode && t.event.target === G.node() && t.event.preventDefault(), t.event.ctrlKey && t.event.shiftKey && 68 === t.event.keyCode && (d.options().executeHiddenDebugFeatuers(), t.event.preventDefault())
                            }), t.select("#maxLabelWidthSliderOption")) {
                            var q = !d.options().dynamicLabelWidth();
                            t.select("#maxLabelWidthSlider").node().disabled = q, t.select("#maxLabelWidthvalueLabel").classed("disabledLabelForSlider", q), t.select("#maxLabelWidthDescriptionLabel").classed("disabledLabelForSlider", q)
                        }
                        t.select("#blockGraphInteractions").style("position", "absolute").style("top", "0").style("background-color", "#bdbdbd").style("opacity", "0.5").style("pointer-events", "auto").style("width", d.options().width() + "px").style("height", d.options().height() + "px").on("click", function() {
                            t.event.preventDefault(), t.event.stopPropagation()
                        }).on("dblclick", function() {
                            t.event.preventDefault(), t.event.stopPropagation()
                        }), t.select("#direct-text-input").on("click", function() {
                            F.setDirectInputMode()
                        }), t.select("#blockGraphInteractions").node().draggable = !1, c.prefixModule(webvowl.util.prefixTools(d)), o(), L.updateOntologyInformation(void 0, z), O.parseUrlAndLoadOntology(), c.debugMenu(m), m.updateSettings(), t.select("#reloadSvgIcon").on("click", function() {
                            return t.select("#reloadSvgIcon").node().disabled === !0 ? void d.options().ontologyMenu().clearCachedVersion() : (t.select("#reloadCachedOntology").classed("hidden", !0), void d.options().ontologyMenu().reloadCachedOntology())
            ...
            e.exports = function(e) {
                ...
                function v() {
                    ...
                    for (a = 0; a < d.length; a++) {
                        var c, p, u, f, h, g, v, m, b, x, k, L, M, E, _, O, S = d[a],
                            F = S.property(),
                            I = "black",
                            T = "",
                            A = "",
                            P = "triangleBlack",
                            D = ",line width=2pt";
                        F.linkType && ("dotted" === F.linkType() && (T = ", dotted ", P = "triangleWhite"), "dashed" === F.linkType() && (T = ", dashed "), "values-from" === F.linkType() && (I = "valuesFrom"));
                        var B, R, W, N, H, j, z;
                        if (1 !== S.layers().length || S.loops()) S.isLoop() ? (A = ", tension=3", M = e.math().calculateLoopPoints(S), k = M[0], x = M[1], L = M[2]) : (x = S.label(), k = e.math().calculateIntersection(x, S.domain(), 1), L = e.math().calculateIntersection(x, S.range(), 1)), c = k.x, p = -k.y, u = x.x, f = -x.y, h = L.x, g = -L.y;
                        else {
                            v = e.math().calculateIntersection(S.range(), S.domain(), 1), m = e.math().calculateIntersection(S.domain(), S.range(), 1), b = e.math().calculateCenter(v, m), c = v.x, p = -v.y, u = b.x, f = -b.y, h = m.x, g = -m.y, k = v, x = b, L = m;
                            var V = h - u,
                                U = g - f;
                            E = Math.sqrt(V * V + U * U), V /= E, U /= E, _ = Math.atan2(U, V) * (180 / Math.PI), H = V, j = U
                        }
                        if (i += "\\draw [" + I + T + D + A + "] plot [smooth] coordinates {(" + c + "pt, " + p + "pt) (" + u + "pt, " + f + "pt)  (" + h + "pt, " + g + "pt)};\n", void 0 !== S.property().markerElement()) {
                            "owl:someValuesFrom" !== S.property().type() && "owl:allValuesFrom" !== S.property().type() || (P = "triangleBlue"), z = S.pathObj(), O = Math.floor(z.node().getTotalLength());
                            var G = z.node().getPointAtLength(O - 4),
                                q = z.node().getPointAtLength(O),
                                $ = z.node().getPointAtLength(O - 6);
                            "setOperatorProperty" === S.property().type() && (G = z.node().getPointAtLength(4), q = z.node().getPointAtLength(0), $ = z.node().getPointAtLength(8), P = "Diamond"), B = G.x, R = G.y, W = q.x, N = q.y, H = W - B, j = N - R, E = Math.sqrt(H * H + j * j), H /= E, j /= E, _ = -1 * Math.atan2(j, H) * (180 / Math.PI), _ -= 90, "setOperatorProperty" === S.property().type() && (_ -= 45), h = $.x, g = $.y, 1 !== S.layers().length || S.loops() ? (g *= -1, i += "\\node[" + P + ", rotate=" + _ + "] at (" + h + "pt, " + g + "pt)   (marker" + a + ") {};\n ") : (g *= -1, i += "\\node[" + P + ", rotate=" + _ + "] at (" + h + "pt, " + g + "pt)   (single_marker" + a + ") {};\n ");
                            ...
                            if (S.property().inverse()) {
                                ...
                                B = Q.x, R = Q.y, W = ee.x, N = ee.y, H = W - B, j = N - R, E = Math.sqrt(H * H + j * j), H /= E, j /= E, _ = -1 * Math.atan2(j, H) * (180 / Math.PI), _ -= 90, h = te.x, g = te.y, 1 !== S.layers().length || S.loops() ? (g *= -1, i += "\\node[" + P + ", rotate=" + _ + "] at (" + h + "pt, " + g + "pt)   (INV_marker" + a + ") {};\n ") : (g *= -1, i += "\\node[" + P + ", rotate=" + _ + "] at (" + h + "pt, " + g + "pt)   (INV_single_marker" + a + ") {};\n ")
                            }
                        }
                    }
                            ...
                            if (fe = ",minimum width=" + he + "pt", "owl:disjointWith" !== ne.type())
                                if (ne.inverse()) {
                                    ...
                                    if (ge.backgroundColor()) {
                                        ...
                                        Le.toUpperCase(), Le = Le.slice(1, Le.length), i += "\\definecolor{inv_property" + a + "_COLOR}{HTML}{" + Le + "} \n ", Ce = ", fill=inv_property" + a + "_COLOR "
                                    }
                ...
                String.prototype.replaceAll = function(e, t) {
                            ...
                            for (n = 0; n < b.length; n++) {
                                ...
                                if (x.id = b[n].id(), y.push(b[n].id()), x.type = b[n].type(), p.push(x), w.id = b[n].id(), w.iri = b[n].iri(), w.baseIri = b[n].baseIri(), w.label = b[n].label(), b[n].attributes().length > 0 && (w.attributes = b[n].attributes()), b[n].comment() && (w.comment = b[n].comment()), b[n].individuals().length > 0 && (w.individuals = b[n].individuals()), b[n].annotations() && (w.annotations = b[n].annotations()), b[n].description() && (w.description = b[n].description()), b[n].individuals().length > 0) {
                                    ...
                                    for (o = 0; o < C.length; o++) {
                                        var L = {};
                                        L.iri = C[o].iri(), L.baseIri = C[o].baseIri(), L.labels = C[o].label(), C[o].annotations() && (L.annotations = C[o].annotations()), C[o].description() && (L.description = C[o].description()), C[o].comment() && (L.comment = C[o].comment()), k.push(L)
                                    }
                                    w.individuals = k
                                }
                                u.push(w)
                    ...
                    for (t = 0; t < E; t++) {
                        var S = {},
                            F = {};
                        if (S.id = M[t].id(), S.type = M[t].type(), _.push(S), F.id = M[t].id(), F.iri = M[t].iri(), F.baseIri = M[t].baseIri(), F.label = M[t].label(), M[t].attributes().length > 0 && (F.attributes = M[t].attributes()), M[t].comment() && (F.comment = M[t].comment()), M[t].annotations() && (F.annotations = M[t].annotations()), M[t].maxCardinality() && (F.maxCardinality = M[t].maxCardinality()), M[t].minCardinality() && (F.minCardinality = M[t].minCardinality()), M[t].cardinality() && (F.cardinality = M[t].cardinality()), M[t].description() && (F.description = M[t].description()), F.domain = M[t].domain().id(), F.range = M[t].range().id(), M[t].subproperties()) {
                        ...
                        M[t].inverse() && (F.inverse = M[t].inverse().id()), O.push(F)
                    }
                    ...
                    R.indexOf(W) === -1 && (s._comment = R + " [Additional Information added by WebVOWL Exporter Version: 1.1.3]");
                    ...
                    var z;
                    for (t = 0; t < H.length; t++) z = H[t], delete z.pos, delete z.pinned;
                    for (D.each(function(e) {
                        ...
                        for (t = 0; t < H.length; t++)
                            if (z = H[t], z.id === V.id()) {
                                z.pos = [parseFloat(B[n].x.toFixed(2)), parseFloat(B[n].y.toFixed(2))], B[n].pinned() && (z.pinned = !0);
                                break
                            }
                    }
                    s.settings = {};
                    ...
                    var $, Z, J, Y = e.options().classDistance(),
                    ...
                    var K = e.options().filterMenu(),
                        ...
                        ee = [];
                    for (t = 0; t < Q.length; t++) $ = Q[t].checkbox.attr("id"), Z = Q[t].checkbox.property("checked"), J = {}, J.id = $, J.checked = Z, ee.push(J);
    ...
    324: function(e, t) {
        e.exports = function(e) {
                    ...
                    for (var L in k)
                        if (k.hasOwnProperty(L)) {
                            var M = k[L],
                                ...
                                _ = E.identifier,
                                O = E.value;
                            "isDefinedBy" === _ && (g += m + " rdfs:isDefinedBy <" + O + "> ;\r\n"), "term_status" === _ && (g += m + ' vs:term_status "' + O + '" ;\r\n')
                        }
                }
                if (a.length > 0) {
                    ...
                    for (var T = 0; T < s.length; T++)
                        if (s[T] && s[T].iri()) {
                            var A = C.getPrefixRepresentationForFullURI(s[T].iri()),
                                P = "";
                            P = C.validURL(A) === !0 ? "<" + A + ">" : A, g += m + m + m + P + " \n"
                        }
                    g += ") ;\r\n"
                }
                var D, B = e.getUnfilteredData().properties,
                    R = [];
                for (D = 0; D < B.length; D++) B[D].domain() !== t || "rdfs:subClassOf" !== B[D].type() && "owl:allValuesFrom" !== B[D].type() && "owl:someValuesFrom" !== B[D].type() || R.push(B[D]), B[D].domain() === t && "owl:disjointWith" === B[D].type() && R.push(B[D]);
                for (D = 0; D < R.length; D++) "owl:someValuesFrom" !== R[D].type() ? "owl:allValuesFrom" !== R[D].type() ? "owl:Thing" !== R[D].range().type() && (g += m + " " + R[D].prefixRepresentation + " " + R[D].range().prefixRepresentation + " ;\r\n") : (g += m + " rdfs:subClassOf [ rdf:type owl:Restriction ; \r\n", g += m + "                   owl:onProperty " + R[D].prefixRepresentation + ";\r\n", "owl:Thing" !== R[D].range().type() && (g += m + "                   owl:allValuesFrom " + R[D].range().prefixRepresentation + "\r\n"), g += m + "                 ];\r\n") : (g += m + " rdfs:subClassOf [ rdf:type owl:Restriction ; \r\n", g += m + "                   owl:onProperty " + R[D].prefixRepresentation + ";\r\n", "owl:Thing" !== R[D].range().type() && (g += m + "                   owl:someValuesFrom " + R[D].range().prefixRepresentation + "\r\n"), g += m + "                 ];\r\n");
            ...
            function a(e) {
                ...
                var L;
                if ("owl:Thing" === c.type() && "owl:Thing" === p.type()) L = v(s, e.label(), "rdfs:label", !0), a += L;
                else {
                    L = v(s, e.label(), "rdfs:label"), a += L, "owl:Thing" !== c.type() && (a += s + " rdfs:domain " + c.prefixRepresentation + ";\r\n"), "owl:Thing" !== p.type() && (a += s + " rdfs:range " + p.prefixRepresentation + ";\r\n");
                    var M = a,
                        E = M.lastIndexOf(";");
                    a = M.substring(0, E) + " . \r\n"
                }
            ...
            e.exports = function(e) {
                ...
                function s() {
                    ...
                    n.on("change", function() {
                        ...
                        t.length <= 0 ? (o.text("Select ontology file"), i.property("disabled", !0)) : (o.text(t[0].name), L = t[0].name, i.property("disabled", !1), i.node().click(), e.options().navigationMenu().hideAllMenus())
                    }), i.on("click", function() {
                ...
                function d(e) {
                    ...
                    for (var s, d = e.split("* "), c = 0; c < d.length; c++) {
                        var p = d[c];
                        p.length > 0 && (s = n.append("li"), s.attr("type", "disc"),
                ...
                function h(e) {
                    var t = e[2];
                    return t !== E ? (console.log("The conversion process for file:" + e[1] + " has been canceled!"), void S.conversionFinished(t)) : (_.loadFromOWL2VOWL(e[0], e[1]), void S.conversionFinished())
                }
                ...
                function b(t) {
                    var n = t[0],
                        o = t[1],
                        i = t[2];
                    return i !== E ? (console.log("The conversion process for file:" + o + " has been canceled!"), void S.conversionFinished(i)) : void(200 === n.status ? (_.loadFromOWL2VOWL(n.responseText, o), S.conversionFinished()) : (f('Failed to convert the file. Ontology could not be loaded.<br>Is it a valid OWL ontology? Please check with <a target="_blank"href="http://visualdataweb.de/validator/">OWL Validator</a>'), e.handleOnLoadingError(), S.conversionFinished()))
                }
                ...
                function w() {
                    t.select("#layoutLoadingProgressBarContainer").classed("hidden", !1), F.classed("hidden", !1), I.classed("hidden", !1)
                }
                ...
                return String.prototype.beginsWith = function(e) {
                    ...
                    S.clearCachedVersion(), e.clearGraphData(), _.parseUrlAndLoadOntology(!1)
                    ...
                    T = !1, u(), t.xhr(n, "application/json", function(e, t) {
                        var n = !e;
                        (null !== e && 500 === e.status || t && 0 === t.responseText.length) && (clearTimeout(M), T = !0, c(m, [e, t, i]));
                        var r;
                        n && (clearTimeout(M), T = !0, r = t.responseText, c(h, [r, o, i]))
                    })
                    ...
                    T = !1, u(), t.xhr(n, "application/json", function(e, t) {
                        var n = !e;
                        if ((null !== e && 500 === e.status || t && 0 === t.responseText.length) && (clearTimeout(M), T = !0, n = !1, console.log(t), console.log(t.responseText.length), c(v, [e, t, i])), n) {
                            clearTimeout(M), T = !0;
            ...
            e.exports = function(e) {
                function n() {
                    ...
                    for (t = 0; t < f.length; t++) {
                        ...
                        if (n.push(f[t].id()), o.push(i), f[t].equivalents && f[t].equivalents().length > 0)
                            for (var r = f[t].equivalentsString(), a = r.split(", "), l = 0; l < a.length; l++) n.push(f[t].id()), o.push(a[l])
                    }
                    p = [], u = [];
                    var s, d, c = -1;
                    for (t = 0; t < o.length; t++)
                    ...
                    for (t = 0; t < p.length; t++) {
                        for (var g = p[t], y = u[t], x = "[ ", w = 0; w < y.length; w++) x += y[w].toString(), x += ", ";
                        x = x.substring(0, x.length - 2), x += " ]";
                        var k = y[0];
                        if (y.length > 1) {
                            for (var C = !0, L = 0; L < y.length; L++) y[L] !== k && (C = !1);
                ...
                function a() {
                    ...
                    var m = s + l;
                    m !== s && (m < 0 && s <= 0 && i[0].setAttribute("class", "dbEntrySelected"), m >= a && i[s].setAttribute("class", "dbEntrySelected"), m >= 0 && m < a && (i[m].setAttribute("class", "dbEntrySelected"), s >= 0 && i[s].setAttribute("class", "dbEntry")))
                }
                ...
                function l() {
                    ...
                    for (n = 0; n < v.length; n++) {
                        var l = v[n];
                        void 0 !== l && (o = v[n].toLowerCase(), o.indexOf(a) > -1 && (i.push(v[n]), r.push(n)))
                    }
                    for (e = k.node().children, t = e.length, n = 0; n < t; n++) e[0].remove();
                    var s = i;
                    t = i.length, t > y && (t = y);
                    var p = [],
                        u = [];
                    ...
                    for (t = i.length, t > y && (t = y), n = 0; n < t; n++) {
                        ...
                        C.setAttribute("elementID", u[n]), C.onclick = d(u[n]), C.setAttribute("class", "dbEntry");
                ...
                function s() {
                    ...
                    var t, o = k.node().children,
                        i = o.length;
                    if (h = c.node().value, w.classed("highlighted", !1), w.node().title = "Nothing to locate, enter search term.", 0 !== h.length) {
                        var r, a = [],
                            l = [],
                            s = h.toLowerCase();
                        for (t = 0; t < v.length; t++) {
                            var p = v[t];
                            void 0 !== p && (r = v[t].toLowerCase(), r.indexOf(s) > -1 && (a.push(v[t]), l.push(t)))
                        }
                        for (o = k.node().children, i = o.length, t = 0; t < i; t++) o[0].remove();
                        var u = a;
                        i = a.length, i > y && (i = y);
                        var f = [],
                            m = [];
                        ...
                        for (t = 0; t < i; t++) {
                            var O;
                            O = document.createElement("li"), O.setAttribute("elementID", m[t]), O.setAttribute("class", "dbEntry"), O.onclick = d(m[t]);
                ...
                function d(t) {
                    return function() {
                        var n = t,
                            o = u[n],
                            i = m[n];
                        c.node().value = i, e.resetSearchHighlight(), e.highLightNodes(o), w.node().title = "Locate search term", i !== h && l(), g.hideSearchEntries()
                    }
                }
                var c, p, u, f, h, g = {},
                    v = [],
                ...
                return String.prototype.beginsWith = function(e) {
                    ...
                    b = !0;
                    for (var e = k.node().children, t = e.length, n = 0; n < t; n++) e[0].remove();
                    c.node().value = ""
                }, g.setup = function() {
                    v = [], c = t.select("#search-input-text"), c.on("input", s), c.on("keydown", a), c.on("click", i), c.on("mouseover", o), w.on("click", function() {
                    ...
                    c.node().value = "", w.classed("highlighted", !1), w.node().title = "Nothing to locate, enter search term.";
                    for (var e = k.node().children, t = e.length, n = 0; n < t; n++) e[0].remove()
                }, g
            }
        }).call(t, n(6))
        ...
        (function(t) {
            e.exports = function(e) {
                ...
                function r() {
                    ...
                    for (u = p.length, e = 0; e < u; e++) M[e] = "c_" + r[e], c.indexOf(r[e]) > -1 ? E[e] = "m_" + r[e] : E[e] = void 0, t.select("#" + M[e]).on("mouseover", a), t.select("#" + M[e]).on("mouseout", l), t.select("#" + M[e]).on("click", s), t.select("#" + M[e]).on("touchstart", d);
        ...
        (function(t) {
            e.exports = function(e) {
                ...
                return C.clearOntologyInformation = function() {
                    ...
                    1 === n && (E = !0, F.node().innerHTML = ">", _.classed("hidden", !0), o === !0 ? (_.classed("hidden", !E), O.style("width", "78%"), O.style("-webkit-animation-name", "none"), S.style("width", "78%"), S.style("-webkit-animation-name", "none"), t.select("#WarningErrorMessages").style("width", "78%"), t.select("#WarningErrorMessages").style("-webkit-animation-name", "none")) : (O.style("width", "78%"), O.style("-webkit-animation-name", "sbCollapseAnimation"), O.style("-webkit-animation-duration", "0.5s"), S.style("width", "78%"), S.style("-webkit-animation-name", "sbCollapseAnimation"), S.style("-webkit-animation-duration", "0.5s"), t.select("#WarningErrorMessages").style("width", "78%"), t.select("#WarningErrorMessages").style("-webkit-animation-name", "warn_ExpandRightBarAnimation"), t.select("#WarningErrorMessages").style("-webkit-animation-duration", "0.5s")), e.options().width(window.innerWidth - .22 * window.innerWidth), e.options().navigationMenu().updateScrollButtonVisibility()), 0 === n && (E = !1, _.classed("hidden", !0), F.node().innerHTML = "<", o === !0 ? (O.style("width", "100%"), O.style("-webkit-animation-name", "none"), S.style("width", "100%"), S.style("-webkit-animation-name", "none"), t.select("#WarningErrorMessages").style("width", "100%"), t.select("#WarningErrorMessages").style("-webkit-animation-name", "none")) : (O.style("width", "100%"), O.style("-webkit-animation-name", "sbExpandAnimation"), O.style("-webkit-animation-duration", "0.5s"), S.style("width", "100%"), S.style("-webkit-animation-name", "sbExpandAnimation"), S.style("-webkit-animation-duration", "0.5s"), t.select("#WarningErrorMessages").style("width", "100%"), t.select("#WarningErrorMessages").style("-webkit-animation-name", "warn_CollapseRightBarAnimation"), t.select("#WarningErrorMessages").style("-webkit-animation-duration", "0.5s")), e.options().width(window.innerWidth), e.updateCanvasContainerSize(), e.options().navigationMenu().updateScrollButtonVisibility())
        ...
        (function(t) {
            e.exports = function(e) {
                ...
                function d() {
                    ...
                    o.on("click", function() {
                        var o = t.select(this);
                        o.classed("accordion-trigger-active") ? (e(t.select(o.node().nextElementSibling)),
                            o.classed("accordion-trigger-active", !1)) : (n(t.select(o.node().nextElementSibling)), o.classed("accordion-trigger-active", !0))
                    })
                }
                var c = {},
            ...
            e.exports = function(e) {
                ...
                function r() {
                    ...
                    e.on("click", function() {
                        if (T === !1) {
                            ...
                            }), d.on("click", s), v.on("click", l), O.updateElementWidth(), f.node().focus(), E = e, _ = "", t.select("#addPrefixButton").node().innerHTML = "Save Prefix"
                ...
                function l() {
                    if (this.disabled !== !0) {
                        ...
                        t.select("#prefixContainerFor_" + n).remove(), e.options().removePrefix(n), T = !1, I.updatePrefixModel()
                    }
                }
                    ...
                    if (n && (o = n), o.disabled !== !0) {
                        ...
                        if ("save" === a) {
                            ...
                            if (e.options().updatePrefix(E, c, _, d) === !0) {
                                t.select("#prefixInputFor_" + c).node().disabled = !0, t.select("#prefixURLFor_" + c).node().disabled = !0, t.select("#addPrefixButton").node().innerHTML = "Add Prefix", t.select("#containerFor_" + r).node() && (t.select("#containerFor_" + r).node().title = "Edit prefix and IRI"), o.elementStyle = "edit", T = !1, I.updatePrefixModel();
                                var p = t.select(o);
                ...
                function v(e) {
                    ...
                    if (F.isNode(e) === !0) {
                        ...
                        for (F.isDatatypeProperty(e) === !0 && (p = ["deprecated", "functional"]), n = 0; n < p.length; n++) s = o.append("div").classed("checkboxContainer", !0).style("padding-top", "2px"), d = s.append("input").classed("filterCheckbox", !0).attr("id", "CharacteristicsCheckbox" + n).attr("type", "checkbox").attr("characteristics", p[n]).property("checked", m(e, p[n])), s.append("label").attr("for", "CharacteristicsCheckbox" + n).text(p[n]), d.on("click", y)
                    }
                }
                ...
                function y() {
                    ...
                    e === !0 ? b(M, t) : x(M, t), M.redrawElement(), M.focused(!1), M.toggleFocus()
                }
                ...
                function k(t) {
                    F.isNode(t) && e.changeNodeType(t) === !1 && (F.isDatatype(t) === !0, O.updateSelectionInformation(t)), F.isProperty(t) && e.changePropertyType(t) === !1 && O.updateSelectionInformation(t)
                }

                function C(e) {
                    var t = [];
                    return F.isProperty(e) ? ("owl:DatatypeProperty" === e.type() ? t.push("owl:DatatypeProperty") : (t.push("owl:ObjectProperty"), e.domain() !== e.range() && t.push("rdfs:subClassOf"), t.push("owl:disjointWith"), t.push("owl:allValuesFrom"), t.push("owl:someValuesFrom")), t) : ("rect" === e.renderType() ? (t.push("rdfs:Literal"), t.push("rdfs:Datatype")) : (t.push("owl:Class"), t.push("owl:Thing")), t)
                }
                ...
                function L() {
                    ...
                    o.on("click", function() {
                        var o = t.select(this);
                        o.classed("accordion-trigger-active") ? (e(t.select(o.node().nextElementSibling)), o.classed("accordion-trigger-active", !1)) : (n(t.select(o.node().nextElementSibling)), o.classed("accordion-trigger-active", !0)), O.updateElementWidth()
                    })
                }
                var M, E, _, O = {},
                ...
                return O.clearMetaObjectValue = function() {
                    ...
                    L(), a(), r(), n(), t.select("#titleEditor").on("change", function() {
                    ...
                    if (void 0 === n) t.select("#selectedElementProperties").classed("hidden", !0), t.select("#selectedElementPropertiesEmptyHint").classed("hidden", !1), M = null, O.updateElementWidth();
                    else {
                        ...
                        if (t.select("#element_labelEditor").on("change", function() {
                                ...
                                var o = u(n);
                                if (n.iri() !== o) {
                                    if (F.isProperty(n) === !0 && (t = O.checkProperIriChange(n, o), t !== !1)) return e.options().warningModule().showWarning("Already seen this property", "Input IRI: " + o + " for element: " + n.labelForCurrentLanguage() + " already been set", "Continuing with duplicate property!", 1, !1, t), void O.updateSelectionInformation(n);
                                    if (F.isNode(n) === !0 && (t = e.checkIfIriClassAlreadyExist(o), t !== !1)) return e.options().warningModule().showWarning("Already seen this Class", "Input IRI: " + o + " for element: " + n.labelForCurrentLanguage() + " already been set", "Restoring previous IRI for Element : " + n.iri(), 2, !1, t), void O.updateSelectionInformation(n);
                                    n.iri(o)
                                }
                                ...
                                if (t.event.stopPropagation(), 13 === t.event.keyCode) {
                                    ...
                                    var i = u(n);
                                    if (n.iri() !== i) {
                                        if (F.isProperty(n) === !0 && (o = O.checkProperIriChange(n, i), o !== !1)) return e.options().warningModule().showWarning("Already seen this property", "Input IRI: " + i + " for element: " + n.labelForCurrentLanguage() + " already been set", "Continuing with duplicate property!", 1, !1, o), void O.updateSelectionInformation(n);
                                        if (F.isNode(n) === !0 && (o = e.checkIfIriClassAlreadyExist(i), o !== !1)) return e.options().warningModule().showWarning("Already seen this Class", "Input IRI: " + i + " for element: " + n.labelForCurrentLanguage() + " already been set", "Restoring previous IRI for Element : " + n.iri(), 2, !1, o), void O.updateSelectionInformation(n);
                                        n.iri(i)
                                    }
                                    g(n)
                                }
                                ...
                                if (o) {
                                    var e = t.select("#element_labelEditor").node().value,
                                        i = e.replaceAll(" ", "_"),
                                        r = n.baseIri() + i;
                                    t.select("#element_iriEditor").node().title = n.iri(), t.select("#element_iriEditor").node().value = I.getPrefixRepresentationForFullURI(r)
                                }
                        ...
                        t.select("#element_iriEditor").node().value = I.getPrefixRepresentationForFullURI(y), t.select("#element_iriEditor").node().title = y, O.updateElementWidth()
                    }
        ...
        (function(t) {
            e.exports = function(e) {
                ...
                function i(e) {
                    ...
                    var r = "";
                    i.onload = function() {
                        200 === i.status && (r = i.responseText, f.setCachedOntology(n, r), h = n, L = !0, f.append_message_toLastBulletPoint("<br>Success, <span style='color:yellow'>but you are using a deprecated OWL2VOWL service!<span>"), s(r))
                    }, i.onreadystatechange = function() {
                        4 === i.readyState && 0 === i.status && (f.append_message_toLastBulletPoint("<br>Old protocol also failed to establish connection to OWL2VOWL service!"), O.setErrorMode(), f.append_bulletPoint("Failed to load ontology"), f.append_message_toLastBulletPoint("<br><span style='color:red'>Could not connect to OWL2VOWL service </span>"), O.showErrorDetailsMessage())
                    }, i.send(o)
                }

                function r(e, n) {
                    t.xhr("serverTimeStamp", "application/text", function(t, o) {
                        O.setBusyMode(), t ? (f.append_bulletPoint("Could not establish connection to OWL2VOWL service"), O.setErrorMode(), f.append_bulletPoint("Failed to load ontology"), f.append_message_toLastBulletPoint("<br><span style='color:red'>Could not connect to OWL2VOWL service </span>"), O.showErrorDetailsMessage()) : (u = o.responseText, f.setConversionID(u), n[0] = n[0] + "&sessionId=" + u, n.push(u), e(n))
                    })
                }
                ...
                function l(n) {
                    var o;
                    n.indexOf("new_ontology") !== -1 && (O.hideLoadingIndicator(), e.showEditorHintIfNeeded(), o = "./data/new_ontology.json"), C = !1;
                    var i = "";
                    if (f.cachedOntology(n)) f.append_bulletPoint("Loading already cached ontology: " + n), i = f.cachedOntology(n), C = !0, O.showLoadingIndicator(), s(i);
                    else {
                        var r = "./data/" + n + ".json";
                        o && (r = o), t.xhr(r, "application/json", function(t, o) {
                            var r = !t;
                            r ? (i = o.responseText, s(i)) : (f.append_bulletPoint("Failed to load: " + n), f.append_message_toLastBulletPoint(" <span style='color: red'>ERROR STATUS:</span> " + t.status), e.handleOnLoadingError(), O.setErrorMode())
                        })
                    }
                }
                ...
                return O.checkForScreenSize = function() {
                    ...
                    O.showLoadingIndicator(), O.expandDetails(), t.select("#loadingIndicator_closeButton").classed("hidden", !0), O.scrollDownDetails()
                }, O.showWarningDetailsMessage = function() {
                    t.select("#currentLoadingStep").style("color", "#ff0"), O.showLoadingIndicator(), O.expandDetails(), t.select("#loadingIndicator_closeButton").classed("hidden", !1), O.scrollDownDetails()
                    ...
                    F.classed("hidden", !M), I.on("click", function() {
                        M = !M, F.classed("hidden", !M), I.classed("accordion-trigger-active", M)
                    }), T.on("click", function() {
                        S.classed("hidden", !0)
                    }), O.setBusyMode()
                }, O.updateSize = function() {
                    M = !F.classed("hidden"), F.classed("hidden", !M), I.classed("accordion-trigger-active", M)
                }, O.getDetailsState = function() {
                    return M
                }, O.expandDetails = function() {
                    M = !0, F.classed("hidden", !M), I.classed("accordion-trigger-active", M)
                }, O.collapseDetails = function() {
                    M = !1, F.classed("hidden", !M), I.classed("accordion-trigger-active", M)
                    ...
                    e.clearGraphData(), f.append_message_toLastBulletPoint("<span style='color:red;'>failed</span>"), f.append_message_toLastBulletPoint('<br><span style="color:red;">Error: Received empty graph</span>'), C = !1, e.handleOnLoadingError(), O.setErrorMode()
                    ...
                    u = -1e4, f.setConversionID(u), f.stopLoadingTimer(), e.clearGraphData(), O.setBusyMode(), O.showLoadingIndicator(), O.collapseDetails(), L = !1, t.select("#loadingIndicator_closeButton").classed("hidden", !0), f.clearDetailInformation()
                }, O.parseUrlAndLoadOntology = function(n) {
                    var o = !0;
                    n === !1 && (o = !1), e.clearAllGraphData(), O.initializeLoader(o);
                    ...
                    t.xhr("serverTimeStamp", "application/text", function(o, i) {
                        o ? (f.append_bulletPoint("Could not establish connection to OWL2VOWL service"), O.setErrorMode(), f.append_message_toLastBulletPoint("<br><span style='color:red'>Could not connect to OWL2VOWL service </span>"), O.showErrorDetailsMessage(), t.select("#progressBarValue").style("width", "0%"), t.select("#progressBarValue").classed("busyProgressBar", !1), t.select("#progressBarValue").text("0%")) : (u = i.responseText, f.setConversionID(u), e(n, ["conversionID" + u, u]))
                    })
                    ...
                    if (f.cachedOntology(o)) f.append_bulletPoint("Loading already cached ontology: " + o), i = f.cachedOntology(o), C = !0, s(i);
                        ...
                        if (!r || o && o !== r.name) return f.append_message_toLastBulletPoint('<br><span style="color:red;">No cached version of "' + o + '" was found.</span><br>Please reupload the file.'), O.setErrorMode(), t.select("#progressBarValue").classed("busyProgressBar", !1), void e.handleOnLoadingError();
                    ...
                    o.indexOf("(with warnings)") !== -1 && (L = !0), f.cachedOntology(e) ? (f.append_bulletPoint("Loading already cached ontology: " + n), s(e)) : s(e)
        ...
        (function(t) {
            e.exports = function(e) {
                ...
                return r.node().addEventListener("animationend", function() {
                    ...
                    a = !1, r.style("-webkit-animation-name", "warn_CollapseAnimation"), r.style("-webkit-animation-duration", "0.5s")
                }, n.showEditorHint = function() {
                    for (var e = i.node().children, o = e.length, l = 0; l < o; l++) e[0].remove();
                    var s = i.append("div");
                    s.node().innerHTML = "Editing mode activated.<br>You can now modify an existing ontology or create a new one via the <em>ontology</em> menu.<br>You can save any ontology using the <em>export</em> menu (and exporting it as TTL file).", s.style("padding", "5px"), s.style("line-height", "1.2em"), s.style("font-size", "1.2em");
                    var d = i.append("ul");
                    d.append("li").node().innerHTML = "Create a class with <b>double click / tap</b> on empty canvas area.", d.append("li").node().innerHTML = "Edit names with <b>double click / tap</b> on element.</li>", d.append("li").node().innerHTML = "Selection of default constructors is provided in the left sidebar.", d.append("li").node().innerHTML = "Additional editing functionality is provided in the right sidebar.";
                    var c = i.append("label");
                    c.node().id = "killWarningErrorMessages", c.node().innerHTML = "Got It", t.select("#killWarningErrorMessages").on("click", n.closeEditorHint), a = !0, r.classed("hidden", !1), r.style("-webkit-animation-name", "warn_ExpandAnimation"), r.style("-webkit-animation-duration", "0.5s")
                }, n.disableAllWarnings = function(e) {
                    o = e
                }, n.responseWarning = function(n, l, s, d, c, p) {
                    if (o === !0 && p && p === !1) return void r.classed("hidden", !0);
                    for (var u = i.node().children, f = u.length, h = 0; h < f; h++) u[0].remove();
                    ...
                    if (l.length > 0) {
                        ...
                        var w = b.append("div");
                        w.style("display", "inline-flex"), w.style("max-width", g + "px"), w.node().innerHTML = l
                    }
                    if (s.length > 0) {
                        var k = i.append("div");
                        k.style("padding", "5px");
                        ...
                        var L = k.append("div");
                        L.style("display", "inline-flex"), L.style("max-width", g + "px"), L.node().innerHTML = s
                    }
                    var M = i.append("label");
                    M.node().id = "killWarningErrorMessages", M.node().innerHTML = "Continue", t.select("#killWarningErrorMessages").on("click", function() {
                        a = !1, r.style("-webkit-animation-name", "warn_CollapseAnimation"), r.style("-webkit-animation-duration", "0.5s"), t.select("#blockGraphInteractions").classed("hidden", !0), d(c[0], c[1], c[2], c[3])
                    }), i.append("span").node().innerHTML = "|";
                    var E = i.append("label");
                    E.node().id = "cancelButton", E.node().innerHTML = "Cancel", E.on("click", function() {
                        a = !1, r.style("-webkit-animation-name", "warn_CollapseAnimation"), r.style("-webkit-animation-duration", "0.5s"), t.select("#blockGraphInteractions").classed("hidden", !0)
                    }), r.classed("hidden", !1), a = !0, r.style("-webkit-animation-name", "warn_ExpandAnimation"), r.style("-webkit-animation-duration", "0.5s")
                    ...
                    var M;
                    if (1 === d && (M = i.append("label"), M.node().id = "killWarningErrorMessages", M.node().innerHTML = "Got It", t.select("#killWarningErrorMessages").on("click", function() {
                            a = !1, r.style("-webkit-animation-name", "warn_CollapseAnimation"), r.style("-webkit-animation-duration", "0.5s")
                        })), 2 === d) {
                        M = i.append("label"), M.node().id = "killWarningErrorMessages", M.node().innerHTML = "Got It", t.select("#killWarningErrorMessages").on("click", function() {
                            a = !1, r.style("-webkit-animation-name", "warn_CollapseAnimation"), r.style("-webkit-animation-duration", "0.5s")
                        }), i.append("span").node().innerHTML = "|";
                        var E = i.append("label");
                        E.node().id = "zoomElementThing", E.node().innerHTML = "Zoom to element ", t.select("#zoomElementThing").on("click", function() {
                            e.zoomToElementInGraph(p)
                        }), i.append("span").node().innerHTML = "|";
                        var _ = i.append("label");
                        _.node().id = "showElementThing", _.node().innerHTML = "Indicate element", t.select("#showElementThing").on("click", function() {
                            p.halo() === !1 ? (p.drawHalo(), e.updatePulseIds([p.id()])) : (p.removeHalo(), p.drawHalo(), e.updatePulseIds([p.id()]))
                        })
                    }
                    a = !0, r.classed("hidden", !1), r.style("-webkit-animation-name", "warn_ExpandAnimation"), r.style("-webkit-animation-duration", "0.5s"), r.classed("hidden", !1)
                }, n
            }
        }).call(t, n(6))
    },
